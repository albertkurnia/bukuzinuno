...
<head>
    ...
    <title>Pencarian - Buku Zinuno BNKP Online</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('app-assets/floating-social-share/jquery.floating-social-share.min.css')}}">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
		...
		<div class="navbar-wrapper">
			<div class="navbar-header">
				<ul class="nav navbar-nav">
					<li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="{{url('app-assets/images/logo/bz-logo-light.png')}}" data-expand="{{url('app-assets/images/logo/bz-logo-light.png')}}" data-collapse="{{url('app-assets/images/logo/robust-logo-small.png')}}" class="brand-logo"></a></li>
				</ul>
			</div>
            ...
            <!-- <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-notification nav-item"><a href="#" data-toggle="dropdown" class="nav-link nav-link-label"><i class="ficon icon-mail6"></i><span class="tag tag-pill tag-default tag-info tag-default tag-up">8</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                  ...
                  <li class="list-group scrollable-container"><a href="javascript:void(0)" class="list-group-item">
                      <div class="media">
                        <div class="media-left"><span class="avatar avatar-sm avatar-online rounded-circle"><img src="{{url('app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span></div>
                        <div class="media-body">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{url('app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
...
<footer class="footer navbar-fixed-bottom footer-dark navbar-border">
	<small>
		<p class="clearfix text-muted text-sm-center mb-0 px-2"><span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2017, <a href="https://niastekno.id" target="_blank" class="text-bold-800 grey darken-2">NIASTEKNO </a> All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">Theme by <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">PIXINVENT </a></i></span></p>
	</small>
</footer>
